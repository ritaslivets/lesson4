...
func countAreaOfCircle(radius: Double) -> Double {
...
print(countAreaOfCircle(radius: radius))
...
func printSeason(month: Int) {
    ...
    default : print("неккоректно введенно время!")
    }
}
printSeason(month: 9)
...
func phoneNumber( number: String ){
    ...
    let phoneWithoutCode = String(number.dropFirst(3))
    // TODO: - let operatorCode
    let operatorCode = String(phoneWithoutCode.prefix(2))
    print(" код оператора: \(operatorCode)")
     // TODO: - let phoneNumber
    let phoneNumber = String(phoneWithoutCode.dropFirst(2))
